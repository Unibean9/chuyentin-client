...
import { aboutUsSeoImage, stats } from "./data";
import { StatCounter } from "./stat-counter";

export function StatsSection() {
  return (
    <section className="stats-section relative w-full overflow-visible">
        ...
        <div className="stats-band-stage relative">
          <div className="stats-band-copy relative z-10">
            ...
            <Reveal delay={0.22}>
              <p className="stats-band-tagline text-pretty font-medium leading-7 text-white/88">
                Mỗi con số dưới đây là một phần trong hành trình Chuyên Tin đồng hành cùng học
                sinh ôn thi chuyên Tin và HSG Tin học.
              </p>
            </Reveal>
          </div>
          ...
          <Reveal delay={0.1} className="stats-band-visual">
            <div className="stats-band-photo">
              <Image
                src={aboutUsSeoImage.path}
                alt={aboutUsSeoImage.alt}
                width={aboutUsSeoImage.width}
                height={aboutUsSeoImage.height}
