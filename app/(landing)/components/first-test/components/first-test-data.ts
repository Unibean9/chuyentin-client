...
export const assessmentSteps: AssessmentStep[] = [
  ...
  {
    title: "Chữa bài cùng Mentor",
    copy: "Buổi 1:1 ngắn cùng Mentor chữa lỗi tư duy chưa lộ ra qua đáp số đúng/sai, và trao lộ trình học cá nhân hoá ngay sau buổi.",
  },
];
